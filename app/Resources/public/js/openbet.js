$(document).ready(function(){
	...
	var cloudspan = [14000, 31000, 60000];

	if($( window ).width() < 1200){ 
		animspeed = 10000; 
		cloudspeed = 40000;
		birdspan = [4000, 12000, 20000];
		cloudspan = [7000, 17500, 10000];
	...
	$('#contact_Send').click(function(){
		...
		if (entered_name.length <= 0){$("#contact_name").closest('.form-group').addClass('has-error'); return false;}
		if (entered_job.length <= 0){$("#contact_jobTitle").closest('.form-group').addClass('has-error'); return false;}
		if (entered_company.length <= 0){$("#contact_company").closest('.form-group').addClass('has-error'); return false;}

		if(!validateEmail(entered_email)){
			$("input[type='email']").closest('.form-group').addClass('has-error').append($error);
			return false;
		}
	});
	...
	$("#click_to_close").click(function(){
		$(this).closest('.form-group').parent().removeClass('has-error');
	});
